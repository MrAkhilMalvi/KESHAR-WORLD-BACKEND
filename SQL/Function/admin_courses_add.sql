-- FUNCTION: public.admin_courses_add(character varying, numeric, character varying, boolean, character varying, numeric, character varying, character varying)

-- DROP FUNCTION IF EXISTS public.admin_courses_add(character varying, numeric, character varying, boolean, character varying, numeric, character varying, character varying);
...
ALTER FUNCTION public.admin_courses_add(character varying, numeric, character varying, boolean, character varying, numeric, character varying, character varying)
    OWNER TO postgres;
